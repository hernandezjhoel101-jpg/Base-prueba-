...
await conn.reply(m.chat, `${namebot} ha silenciado las notificaciones para el canal *${chtitle}* con éxito.`, m) 
} catch (e) {
reportError(e)
}
break
...
await conn.reply(m.chat, `${namebot} ha dejado de silenciar las notificaciones para el canal *${chtitle}* con éxito.`, m) 
} catch (e) {
reportError(e)
}
break
...
await conn.sendMessage(ch, { text: `> ${namebot} ha cambiando la imagen del canal *${chtitle}* con éxito.`, contextInfo: {
externalAdReply: {
title: "【 🔔 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐂𝐈𝐎́𝐍 🔔 】",
...
await conn.sendMessage(ch, { text: `🍬 ${namebot} ha eliminado la imagen del canal *${chtitle}* con éxito.`, contextInfo: {
externalAdReply: {
title: "【 🔔 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐂𝐈𝐎́𝐍 🔔 】",
...
ch
if (!text) return await conn.reply(m.chat, `> Ingrese el ID o enlace de un canal de WhatsApp seguido de un espacio y la opción del modo de reacciones para el canal.
...
// await conn.reply(m.chat, `> El bot ha establecido el modo de reacciones como \`"${mode}"\` para el canal *${chtitle}*`, m)
await conn.sendMessage(ch, { text: `> ${namebot} ha establecido el modo de reacciones como \`"${mode}"\` para el canal *${chtitle}*`, contextInfo: {
externalAdReply: {
title: "【 🔔 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐂𝐈𝐎́𝐍 🔔 】",
...
await conn.sendMessage(ch, { text: `> ${namebot} ha cambiado el nombre del canal *${name}*\n\n*Anterior nombre:* ${chtitle}\n*Nuevo nombre:* ${name}`, contextInfo: {
externalAdReply: {
title: "【 🔔 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐂𝐈𝐎́𝐍 🔔 】",
...
await conn.sendMessage(ch, { text: `> ${namebot} ha modificado la descripción del canal *${chtitle}*`, contextInfo: {
externalAdReply: {
title: "【 🔔 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐂𝐈𝐎́𝐍 🔔 】",
